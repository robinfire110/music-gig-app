...
const Calculator = () => {
    ...
    return (
        <div>
                        ...
                        <Row className="mb-3" xs={1} lg={3}>
                            ...
                            <Col>
                                ...
                                <InputGroup>
                                    ...
                                    <Form.Control placeholder="Ex. 1" disabled={!gigNumEnabled}></Form.Control>
                                    <TooltipButton text=""/>
                                </InputGroup>
                            </Col>
                        </Row>
                    ...
                    <Row className="mb-3" xs={1} lg={2}>
                        <Col>
                            <Row className="mb-1">
                                ...
                                <InputGroup>
                                    ...
                                    <Form.Control placeholder="Ex. 20" disabled={!totalMileageEnabled}></Form.Control>
                            ...
                            <Row className="mb-3">
                                ...
                                <InputGroup>
                                    ...
                                    <Form.Control placeholder="Ex. 20" disabled={!mileageCoveredEnabled}></Form.Control>
                                    <TooltipButton text=""/>
                                </InputGroup>
                            </Row>
                        </Col>
                        <Col>
                            ...
                            <InputGroup>    
                                ...
                                <Form.Control placeholder="Ex. 0.30" disabled={!totalMileageEnabled}></Form.Control>
                ...
                <Form.Group>
                    <Row className="mb-3" xs={1} lg={2}>
                        <Col>
                            ...
                            <Form.Control placeholder="Ex. 20" disabled={!individualPracticeEnabled}></Form.Control>
                        ...
                        <Col>
                            ...
                            <Form.Control placeholder="Ex. 20" disabled={!rehearsalHoursEnabled}></Form.Control>
                    ...
                    <Row className="mb-3" xs={1} lg={2}>
                        <Col>
                            ...
                            <InputGroup>
                                ...
                                <InputGroup.Text>%</InputGroup.Text>
                                <Form.Control placeholder="Ex. 17.5" disabled={!taxEnabled}></Form.Control>
                            <TooltipButton text=""/>
                            </InputGroup>
                        </Col>
                        <Col>
                            ...
                            <Form.Control placeholder="Ex. 20" disabled={!otherFeesEnabled}></Form.Control>
                            <TooltipButton text=""/>
                            </InputGroup>
                        </Col>
                    </Row>
            ...
            <Row>
                <Col>
                    <h4>Total Hourly Wage: {Intl.NumberFormat('en-US', {style: 'currency', currency: "USD"}).format(hourlyWage)}</h4>
                </Col>
                <Col>
