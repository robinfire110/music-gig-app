...
router.get("/distance_matrix/:origin_zip/:destination_zip", async (req, res) => {
    try {
        ...
        await axios.get(`https://maps.googleapis.com/maps/api/distancematrix/json?destinations=${destination_zip}&origins=${origin_zip}&units=imperial&key=${process.env.API_GOOGLE_MAPS}`).then(api_res => {
