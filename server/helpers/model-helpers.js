...
async function getInstrumentId(instrument)
{
    ...
    {
        let instrumentId = (await db.Instrument.findOne({where: {name: instrument}}))?.instrument_id;
    }
    else
    {
        let instrumentId = (await db.Instrument.findOne({where: {instrument_id: instrument}}))?.instrument_id;
    }
    return instrumentId;
}
